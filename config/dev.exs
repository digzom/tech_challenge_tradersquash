...
config :tech_challenge_tradesquash, TechChallengeTradesquashWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "eMTMWuy1Z0AEPVoabZSwyEJ1+50X01/II364GMqjZxymRqnzel2lJDWw31etTGXH",
  watchers: [
...
config :tech_challenge_tradesquash, TechChallengeTradesquashWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/tech_challenge_tradesquash_web/(live|views)/.*(ex)$",
      ~r"lib/tech_challenge_tradesquash_web/templates/.*(eex)$"
    ]
  ]
